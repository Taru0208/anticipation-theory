...
**Design principle:** make risky actions have higher expected value than safe actions. Verified across combat, resource, and card draft game structures (356 tests).
...
```bash
cd python
python3 -m pytest tests/ -v              # Run all 356 tests
...
| **5** | Entropy Preservation | Formal proof: GDS → ∞ ⟺ entropy preserved; A₁ = C(a+b-2,a-1)/2^{a+b-1}; A₂ = \|a-b\|×A₁ |
